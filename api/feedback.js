...
module.exports = async (req, res) => {
  ...
  const prompt = [
    ...
    '"""',
    "",
    "다음 5개 기준으로 한국어 피드백을 작성하세요. 각 기준은 소제목(예: '1. 구체성:')을 붙이고 2~3문장 이내로 간결하게 쓰세요.",
    "1. 구체성: 활동의 과정과 결과가 구체적인 사례로 드러나는지",
    `2. 전공 적합성: ${targetMajor} 전공과의 연계성이 잘 드러나는지, 부족하면 보완 방향 제안`,
    "3. 탐구역량: 스스로 질문하고 확장해 탐구한 과정이 드러나는지",
    "4. 표현 다듬기: 더 명확하고 생기부다운 문장으로 다듬을 구체적 제안 1~2가지",
    "5. 개인정보 주의: 실명, 특정 인물, 사진, 자격증·어학시험 점수 등 기재 불가 정보가 보이면 구체적으로 지적하고, 없으면 '특별히 우려되는 부분은 없습니다'라고 쓰세요.",
    "",
    "전체 400자 내외로, 학생을 격려하는 따뜻한 어투로 작성하세요."
  ].join("\n");
